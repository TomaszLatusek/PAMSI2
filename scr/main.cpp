...
int main()
{
    ...
    // ListGraph *graf = Graph::generateRandom<ListGraph>(500, 100);
    // MatrixGraph *graf2 = Graph::generateRandom<MatrixGraph>(500, 100);

    // graf->sort();
    // graf2->sort();

    // auto start1M = std::chrono::high_resolution_clock::now();
    // std::cout << graf->kruskal() << std::endl;
